...
class PostCRUDTests(TestCase):
    def setUp(self):
        self.author = User.objects.create_user(username="james", password="pwd12345")
        self.other = User.objects.create_user(username="joseph", password="pwd12345")
    ...
    def test_create_as_logged_in(self):
        self.client.login(username="james", password="pwd12345")
    ...
    def test_update_only_author(self):
        ...
        self.client.login(username="joseph", password="pwd12345")
